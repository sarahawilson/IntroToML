...
if __name__ == "__main__":
    print("MLPL - Machine Learning Pipeline - Networks")
    ...
    myKCrossValHelper.runKFoldCrossVal_Linear_Regression_Tune('Computer Hardware')
    myKCrossValHelper.runKFoldCrossVal_Linear_Regression_Tune('Albalone')
    myKCrossValHelper.runKFoldCrossVal_Linear_Regression_Tune('Forest Fire')
